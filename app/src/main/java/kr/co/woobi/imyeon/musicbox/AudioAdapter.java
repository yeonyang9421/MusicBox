...
public class AudioAdapter extends CursorRecyclerViewAdapter<RecyclerView.ViewHolder> {
    ...
    private class AudioViewHolder extends RecyclerView.ViewHolder {
        ...
        private AudioViewHolder(@NonNull View view) {
            super(view);
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    AudioApplication.getmInstance().getServiceInterface().setPlayList(getAudioIds()); //재생목록등록하기
                    AudioApplication.getmInstance().getServiceInterface().play(mPosition); //선택한 오디오 재생
                }
            });
        }
